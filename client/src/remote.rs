...
use space_lt_common::protocol::{ClientMsg, ServerMsg, read_server_msg, write_client_msg};
...
/// Executes `ssh <target> space_lt_server --list-models` and parses `name\tpath` lines.
